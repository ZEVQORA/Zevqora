...
- Real Supabase web auth plus direct email/password sign-in inside ZEVQORA Desktop. Google/GitHub OAuth remains available on the website.
...
├── desktop-auth.html              legacy desktop browser-auth compatibility route
