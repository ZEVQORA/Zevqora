...
def create_app(
    *,
    ...
    application.add_middleware(
        ...
        # The shell renders the hosted product, so its page is on a public
        # origin and every call to 127.0.0.1 is a public -> private request.
        # Chrome fails those at preflight unless the local server opts in.
        # Only origins already on the allowlist above are granted it, and the
        # per-launch token still decides what may actually be done.
